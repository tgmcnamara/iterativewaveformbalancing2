...
mpc.load = [
    ...
    3   2   1  113.04e6    22.8e6  0;
    4   2   1  57.36e6 0   4.68e6;
    5   2   1  9.12e6  1.92e6  0;
    6   2   1  13.44e6 9e6 0;
    9   2   1  35.4e6  19.92e6 0;
    10  2   1  10.8e6  6.96e6  0;
    11  2   1  4.2e6   2.16e6  0;
    12  2   1  7.32e6  1.92e6  0;
    13  2   1  16.2e6  6.96e6  0;
    14  2   1  17.88e6 6e6 0;
];
% generator data
%	bus	Type Configuration Active_Power Reactive_Power Max_Q Min_Q
%	Source_resistance Source_Inductance Base_V
mpc.gen = [
    1   2    3    163e6   0   inf   -inf   0.8929  16.58e-3    146.28e3;
    2   2    3    90e6   0   inf   -inf   0.8929  16.58e-3    144.21e3;
];
...
%	Source_resistance Source_Inductance Base_V
mpc.sync_cond = [
    3   2    3    0   0   inf   -inf   0.8929  16.58e-3    139.38e3;
    6   3    3    0   25.276e6   inf   -inf   0.8929  16.58e-3    147.66e3;
    8   3    3    0   30.144e6   inf   -inf   0.8929  16.58e-3    150.42e3;
];
